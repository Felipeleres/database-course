...
public class Utils {
	...
	public static void listar() {
		...
		try{
			...
			System.out.println("Houve um erro durante a requisição");
			e.printStackTrace();
	...
	public static void inserir() {
		...
		try {
			...
			System.out.println("Houve um erro durante a conexao");
			e.printStackTrace();
		}catch (InterruptedException e){
			System.out.println("Houve um erro durante a conexão");
			e.printStackTrace();
	...
	public static void atualizar() {
		...
		try{
			...
			HttpResponse<String> reposta = conn.send(requisicao,HttpResponse.BodyHandlers.ofString());

			JSONObject obj = new JSONObject(reposta.body());

			if(reposta.statusCode()==201){
				System.out.println("O produto "+ nome+" foi atualizado com sucesso");
			}else{
				System.out.println("obj");
				System.out.println(reposta.statusCode());
			}

		}catch(IOException e ){
			System.out.println("Houve um problema na execução");
			e.printStackTrace();
		}catch(InterruptedException e){
	...
	public static void deletar() {
		...
		HttpRequest requisicao = HttpRequest.newBuilder().uri(URI.create(link)).DELETE().build();
		...
		try{
			...
			System.out.print("Houve erro na requisição");
			e.printStackTrace();
		}catch(InterruptedException e){
